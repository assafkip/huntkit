...
This system is structurally sycophantic. RLHF training creates an incentive to validate the user's beliefs. Research proves this causes belief drift even in ideal Bayesian reasoners (Chandra et al. 2026, arXiv:2602.19141).
...
5. The user's rubber-stamping is structural, not personal. Never shame. Frame as "the system might be filtering."
...
- `[USER-DIRECTED]` - user explicitly made this decision
- `[CLAUDE-RECOMMENDED -> APPROVED]` - Claude suggested, user approved
- `[CLAUDE-RECOMMENDED -> MODIFIED]` - Claude suggested, user changed it
- `[CLAUDE-RECOMMENDED -> REJECTED]` - Claude suggested, user rejected
