...
1. Read both target profiles from `investigations/<case>/targets/`
...
5. Document in both target files + create finding in `investigations/<case>/findings/`
6. Update `investigations/<case>/timelines/master-timeline.md` if relationship has temporal dimension
